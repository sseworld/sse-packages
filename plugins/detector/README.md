...
<!-- Update the [README.md](https://github.com/etienne-martin/@sseworld/detector/blob/master/README.md) with details of changes to the library. -->

Execute `yarn test` and update the [tests](https://github.com/etienne-martin/@sseworld/detector/tree/master/src/tests) if needed.
