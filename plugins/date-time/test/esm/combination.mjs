...
import ja from 'date-time/locale/ja';

import day_of_week from 'date-time/plugin/day-of-week';
import meridiem from 'date-time/plugin/meridiem';
import microsecond from 'date-time/plugin/microsecond';
import ordinal from 'date-time/plugin/ordinal';
import timespan from 'date-time/plugin/timespan';
import timezone from 'date-time/plugin/timezone';
import two_digit_year from 'date-time/plugin/two-digit-year';
