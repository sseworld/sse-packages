...
export default [
  {
    input: "src/index.js",
    output: [
      { file: "esm/date-time.es.js", format: "es" },
      { file: "esm/date-time.mjs", format: "es" },
      {
        file: "date-time.js",
        format: "umd",
        name: "date",
  ...
  },
  {
    ...
    output: [
      ...
      {
        file: "locale/pa-in.js",
        format: "umd",
        name: "date.locale.pa-in",
        esModule: false,
      },
    ],
  },
  ...
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/day-of-week.js",
        format: "umd",
        name: "date.plugin.day-of-week",
        esModule: false,
      },
    ],
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/meridiem.js",
        format: "umd",
        name: "date.plugin.meridiem",
        esModule: false,
      },
    ],
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/microsecond.js",
        format: "umd",
        name: "date.plugin.microsecond",
        esModule: false,
      },
    ],
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/ordinal.js",
        format: "umd",
        name: "date.plugin.ordinal",
        esModule: false,
      },
    ],
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/timespan.js",
        format: "umd",
        name: "date.plugin.timespan",
        esModule: false,
      },
    ],
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/timezone.js",
        format: "umd",
        name: "date.plugin.timezone",
        esModule: false,
      },
    ],
  },
  {
    ...
    output: [
      ...
      {
        file: "plugin/two-digit-year.js",
        format: "umd",
        name: "date.plugin.two-digit-year",
        esModule: false,
      },
    ],
  },
  {
    input: "src/index.js",
    output: [
      { file: "esm/date-time.es.min.js", format: "es" },
      {
        file: "date-time.min.js",
        format: "umd",
        name: "date",
        esModule: false,
      },
